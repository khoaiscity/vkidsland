...
function Home() {
  ...
  const handleOnchange = event => {
    ...
    if (
      err.length === 0 &&
      dataFrom.hasOwnProperty("name") &&
      dataFrom.hasOwnProperty("phone") &&
      dataFrom.hasOwnProperty("email")
    ) {
      setDisabled(false);
    }
  };
                              ...
                              <div className="awards-section-content text-center black">
                                ...
                                {item.isSliderPhoto && (
                                  <button
                                    ...
                                    data-toggle="modal"
                                    data-target={
                                      ".bd-example-modal-lg-slider-" + index
                                    }
                                  >
                                    View Photo{" "}
                                    <i className="fa fa-play-circle px-1"></i>
                ...
                <div className="address-container text-center black">
                  ...
                  <div className="branch-content">
                    ...
                    <div className="contact-number d-inline-block ">
                      <p className="d-flex">
                        <i className="icon-phone mr-2"></i>General Line:
                        &nbsp;010-2775678
                      </p>
                      <p className="d-flex">
            ...
            <div className="p-5">
              <div className="contact-container py-4">
                ...
                <div className="contact-form">
                  ...
                  <button
                    className={
                      "contact-send-btn style1-btn my-1 " +
                      (disabled ? "disabled" : "")
                    }
                    onClick={disabled ? () => {} : hanldeOnSubmit}
                  >
                    Send
                  </button>
                </div>
