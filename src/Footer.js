...
function Footer() {
  ...
  useEffect(() => {
    if (term === null) {
      fetch(
        "api/system-static-setting?type=term-and-conditions&key=privacy&key=disclaimer&key=code-of-ethics&key=term-of-use&key=income&key=social-media&key=general&key=distributor-rule-and-regulation"
      )
        ...
        <div className="row footer-media d-flex align-items-center">
          <div className="col-md-10 col-8">
              ...
              {term &&
                ...
                term.map((item, index) => (
                  ...
                  <a
                    href=""
                    data-toggle="modal"
                    data-target={".term-modal-lg-" + index}
                  >
                    {" "}
                    <span
            ...
            <div className="reserved pt-2 px-2">
              AJL932213 | © {new Date().getFullYear()} VKIDS TREND. 201701020709
              (1234875-M) All Rights Reserved
            </div>
          </div>
            ...
            <div className="text-right">
              <ul className="list-unstyled list-inline">
                <li className="list-inline-item">
                  ...
                  <a
                    className="btn-floating btn-sm"
                    href="https://www.youtube.com/channel/UCG4d6XVAfUctT91blHb5VyQ"
                  >
                    {" "}
                    <img
                      className="icon-fb-footer"
                      src="assets/icons/youtube-circular-logo.svg"
                      alt="youtube"
                    />{" "}
                  </a>
                </li>
