...
function Footer() {
  ...
  useEffect(() => {
    if (term === null) {
      fetch('api/system-static-setting?type=term-and-conditions&key=privacy&key=code-of-ethics&key=term-of-use&key=income&key=social-media&key=distributor-rule-and-regulation&key=general')
